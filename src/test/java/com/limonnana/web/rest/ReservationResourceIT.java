...
import com.limonnana.Starter02App;
...
import com.limonnana.service.ReservationService;
...
/**
 * Integration tests for the {@Link ReservationController} REST controller.
 */
@SpringBootTest(classes = Starter02App.class)
public class ReservationResourceIT {
    ...
    public void setup() {
        ...
        final ReservationController reservationResource = new ReservationController(reservationService);
